"""Use the final version of electric_car.py form this section. Add a method to the Battery class called upgrade_battery().
...
my_tesla.battery.upgrade_battery(70)
my_tesla.battery.get_range()